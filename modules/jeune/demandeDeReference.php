...
if(isset($_POST['envoi'])){
    ...
    $insertUser = $bdd->prepare('INSERT INTO reference(engagement, dureeEngagement, milieuEngagement, nomReferent, prenomReferent, emailReferent, checkbox1, checkbox2, checkbox3, checkbox4, checkbox5, checkbox6, checkbox7, checkbox8, checkbox9, checkbox10, checkbox11, checkbox12, uniqueLink) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)');

    // Generate a unique link
    $uniqueLink = 'https://jeune64.000webhostapp.com/modules/referent/index.php?reference=' . uniqid();
    $insertUser->execute(array($engagement, $dureeEngagement, $milieuEngagement, $nomReferent, $prenomReferent, $emailReferent, $checkbox1, $checkbox2, $checkbox3, $checkbox4, $checkbox5, $checkbox6, $checkbox7, $checkbox8, $checkbox9, $checkbox10, $checkbox11, $checkbox12, $uniqueLink));
    ...
    $mail->Body = "
    <p>Cher " . $_SESSION['prenomReferent'] . " " . $_SESSION['nomReferent'] . ", vous venez de recevoir une demande de confirmation d'une demande de référence émise par " . $_SESSION['prenom'] . " " . $_SESSION['nom'] . " dans le cadre du projet Jeunes 6.4.</p>
    <p>Ce dernier est un dispositif de valorisation de l'engagement des jeunes en Pyrénées-Atlantiques. Il est soutenu par l'État, le Conseil Général, le Conseil Régional, les CAF Béarn Soule et Pays Basque, la MSA (Mutualité Sociale Agricole) et la CPAM (Caisse Primaire d'Assurance Maladie).</p>
    <p>Ce dispositif vise à encourager et reconnaître l'engagement des jeunes dans des actions citoyennes, solidaires, culturelles, sportives ou environnementales. Il offre aux jeunes des opportunités de s'impliquer dans des projets concrets et bénéfiques pour la société, tout en valorisant leurs compétences et en favorisant leur insertion sociale et professionnelle.</p>
    <p>Le soutien financier et institutionnel apporté par ces différentes entités permet la mise en place d'actions concrètes et la reconnaissance de l'engagement des jeunes dans le département des Pyrénées-Atlantiques.</p>
    <p>Veuillez cliquer sur le lien suivant pour confirmer la demande de référence : <a href='$uniqueLink'>Confirmer la demande de référence</a></p>
