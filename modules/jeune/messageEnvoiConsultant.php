...
// Redirect to the connection page if the session ID is not set
...
if(isset($_POST['envoi'])){
    ...
    // Prepare and execute the query to retrieve the user data from the database
    ...
    // Redirect to the message confirmation page
...
// Handle the "CENTRE DE CONTRÔLE" button click event
...
// Handle the "SE DÉCONNECTER" button click event
if(isset($_POST['seDeconnecter'])){
    
    // Destroy the session and redirect to the connection page
    session_destroy();
    session_destroy();
    echo '<script>window.location.href = "./connexion.php";</script>';
    exit();
...
<html lang="fr">
    ...
    <body>
        ...
        <div>
            ...
            <div>
                <p class="formTitle">Votre demande de référence a été envoyé au consultant avec succès.</p>
            </div>
        </div>
        <footer>
